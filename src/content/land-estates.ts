...
export const LAND_ESTATES: LandEstate[] = [
  {
    ...
    plan: {
      viewBox: "0 0 100 152",
      roads: [
        // Левая ось: дорога В ЗАЗОРЕ между R6 и R1 (горизонталь) → поворот вниз
        // в коридоре между R-колонкой (закат/море) и M-колонкой до R10/M10.
        "M5,56 C14,56 22,56 28,57 C30,68 31,80 34,94 C37,104 39,112 41,120",
        // Правая ось: в зазоре между центральной (M1–M4) и правой (M5–M8).
        "M59.5,80 C60,92 60,100 62,108 C66,116 71,121 75,128",
        // Нижняя перемычка в зазоре между M4 и M10/M7 (связывает оси).
        "M40,111 C47,110 54,109 60,109",
        // Дорога В ЗАЗОРЕ между R5 и R10 (горизонталь) → поворот вниз в коридоре
        // между C10 (слева) и R10 (справа).
        "M40,113.5 C33,112.5 27,113 22,115.5 C24,120 26,125 28,130",
      ],
      seaSide: "left",
    },
    plots: [
