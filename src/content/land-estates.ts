...
export const LAND_ESTATES: LandEstate[] = [
  {
    ...
    plan: {
      viewBox: "0 0 100 152",
      roads: [
        // Главная «ось»: дорога между R6 и R1 (горизонталь слева) → вниз между
        // R-колонкой (закат/море) и M-колонкой до низа у R10/M10.
        "M4,55 C13,54 21,55 27,57 C30,69 32,82 35,95 C37,105 39,113 41,120",
        // Правая дорога: между центральной (M1–M4) и правой (M5–M8) колоннами.
        "M62,80 C64,92 65,103 67,113 C70,123 72,131 74,138",
        // Нижняя перемычка: связывает ось с правой дорогой (над R10/M10).
        "M30,124 C42,121 54,121 66,121",
        // Съезд вниз-влево к R10 / C10 (C10 — отдельный лот через дорогу).
        "M41,120 C36,126 30,130 24,133",
      ],
      seaSide: "left",
    },
    plots: [
      ...
      {
        code: "C10",
        plotShape: [[7, 117], [21, 113.5], [29.5, 127], [13, 132]],
        status: "available",
        tenure: "Freehold",
        areaSqm: 2476,
        priceThb: 14_701_250,
