...
export const KB_ARTICLES_RU: KbArticle[] = [
  ...
  },
  {
    ...
    body: [
      ...
      {
        ul: [
          "**Переведите средства из-за рубежа в иностранной валюте.** Отправьте SWIFT со своего зарубежного счёта на тайский банковский счёт для сделки: личный счёт, эскроу юриста или счёт застройщика. Средства должны прийти в иностранной валюте (USD, EUR, GBP и др.), а не уже сконвертированными в баты.",
