...
export const FAQ_ITEMS_RU: FaqItem[] = [
  ...
  },
  {
    ...
    answer: [
      ...
      { ul: [
        "**Международный перевод SWIFT** на клиентский счёт партнёрской юрфирмы — или напрямую продавцу при закрытии. Комиссия банка $50–200 за перевод.",
      ...
      "Принимающим банком должен быть крупный тайский банк (Bangkok Bank, Kasikorn, SCB). Юрист обычно открывает или использует отдельный клиентский счёт, и задаток высвобождается только при закрытии — не передаётся продавцу заранее.",
    ],
  },
  {
    id: "q20",
