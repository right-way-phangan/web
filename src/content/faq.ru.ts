...
export const FAQ_ITEMS_RU: FaqItem[] = [
  ...
  },
  {
    ...
    answer: [
      ...
      { ul: [
        "**Поиск титула в Земельном департаменте** (~1–2 дня, ~500 THB) — подтверждает, что Chanote зарегистрирован на продавца, без обременений, ипотек и судебных решений. Выявляет сособственников (иногда на одном Chanote 4–5 членов семьи — все должны согласиться на продажу).",
  ...
  },
  {
    ...
    answer: [
      "Небольшие расхождения (< 2%) обычны и обычно в пределах погрешности съёмки. Большие требуют разбирательства:",
      { ul: [
      ...
      "Right Way выполняет GPS-проверку по каждому Chanote, который выставляет. Любое расхождение свыше 2% фиксируется в карточке объекта.",
    ],
  },
  ...
  },
  {
    ...
    answer: [
      ...
      "Наша опубликованная схема комиссий — на [странице Услуги](/ru/services): базовый сбор плюс поисковый сбор, оплачиваемые продавцом, с небольшой надбавкой за сложные корпоративные структуры, оплачиваемой покупателем.",
      "Есть исключения:",
      { ul: [
  ...
  },
  {
    ...
    answer: [
      ...
      "Хорошая практика: будьте прозрачны с Right Way и юристом продавца, как только возникают сомнения. Мы помогаем перетоговорить, отложить или аккуратно свернуть. Сюрпризы в последний момент портят отношения и обходятся дороже.",
    ],
  },
  {
    id: "q25",
  ...
  },
  {
    ...
    answer: [
      ...
      { ul: [
        ...
        "Арендная доходность скромная — 4–7% валовой на аренде вилл, ниже на земле. После управления, обслуживания, простоя и налогов чистая доходность выходит на 2–4%.",
