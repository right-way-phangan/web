...
export const FAQ_ITEMS_RU: FaqItem[] = [
  ...
  },
  {
    ...
    answer: [
      ...
      { ul: [
        "**Международный перевод SWIFT** на клиентский счёт партнёрской юрфирмы — либо на лицензированный банковский эскроу-счёт для крупных сделок — или напрямую продавцу при закрытии. Комиссия банка $50–200 за перевод.",
      ...
      "Принимающим банком должен быть крупный тайский банк (Bangkok Bank, Kasikorn, SCB). Юрист обычно открывает или использует отдельный клиентский счёт; учтите, что по тайскому закону формальным эскроу-агентом может быть только лицензированный банк — не юрист и не агент, — поэтому полноценный банковский эскроу-счёт оформляется отдельно для крупных сделок.",
    ],
  },
  {
    id: "q20",
