...
export const metadata: Metadata = {
  ...
  description:
    "Безопасный способ для иностранца владеть виллой на Пангане: здание — на вас, земля — в зарегистрированной долгосрочной аренде, без номиналов и тайской компании-прокладки. Зарегистрированная аренда, банковский escrow, двухуровневый due diligence.",
  alternates: {
...
const PILLARS = [
  ...
  {
    icon: Landmark,
    title: "Деньги — через банковский escrow",
    text: "Средства лежат на escrow в лицензированном банке и высвобождаются по регистрации — а не на клиентском счёте юриста. Вы платите, когда аренда и здание действительно ваши по бумагам.",
  },
  {
    icon: ClipboardCheck,
  ...
  return (
    <>
      ...
      <PageHero
        ...
        lede="Лизхолд — это как международные покупатели держат дом на Пангане без тайской компании-прокладки: здание на ваше имя, земля в зарегистрированной долгосрочной аренде, деньги через банковский escrow. Вот как именно это работает."
      />
      ...
      <section className="container-prose py-16 md:py-24">
        ...
        <div className="mt-16 rounded-sm border border-forest-500/10 bg-cream-50 p-8 md:mt-20 md:p-10">
          ...
          <p className="mt-4 max-w-prose text-base leading-relaxed text-forest-500/75">
            Зарегистрированная аренда, здание на ваше имя, деньги через банковский escrow и те же
